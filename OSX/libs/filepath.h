...
extern int FilePath_Export(FilePath *path, char *outBuf, size_t outBufLen);

//export directory path to an entry
extern int FilePath_ExportDirPath(FilePath *path, char *outBuf, size_t outBufLen);
...
extern int FilePath_Convert(FilePath *path, const char *sourcePath, size_t len);
