...
${OBJECTDIR}/src/input.o: src/input.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/usr/include/SDL -Iinclude -I../core -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/input.o src/input.c

${OBJECTDIR}/src/video.o: src/video.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/usr/include/SDL -Iinclude -I../core -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/video.o src/video.c

${OBJECTDIR}/src/main.o: src/main.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/usr/include/SDL -Iinclude -I../core -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/main.o src/main.c

${OBJECTDIR}/_ext/761097586/data.o: ../core/data.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/761097586
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/usr/include/SDL -Iinclude -I../core -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/761097586/data.o ../core/data.c

${OBJECTDIR}/_ext/761097586/bagasmi.o: ../core/bagasmi.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/761097586
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/usr/include/SDL -Iinclude -I../core -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/761097586/bagasmi.o ../core/bagasmi.c

${OBJECTDIR}/_ext/761097586/execops.o: ../core/execops.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/761097586
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/usr/include/SDL -Iinclude -I../core -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/761097586/execops.o ../core/execops.c
